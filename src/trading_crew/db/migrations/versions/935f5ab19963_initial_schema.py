...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('pending', 'open', 'partially_filled', 'filled', 'cancelled', 'rejected', name='order_status'), nullable=False),
    ...
    sa.Column('symbol', sa.String(length=20), nullable=False),
    sa.Column('exchange', sa.String(length=30), nullable=False),
    sa.Column('signal_type', sa.Enum('buy', 'sell', 'hold', name='signal_type'), nullable=False),
